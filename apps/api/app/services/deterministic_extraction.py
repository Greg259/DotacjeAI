...
SOURCE_PROFILES = {
    ...
    "pruszkow-wymiana-pieca-2026": {
        ...
        "title": "Dofinansowanie do wymiany pieca w Pruszkowie — 2026",
        "organizer": "Miasto Pruszków",
        "location_slugs": ["pruszkow"],
        "beneficiary_types": [BeneficiaryType.NATURAL_PERSON, BeneficiaryType.OWNER],
        "property_types": [PropertyType.EXISTING_BUILDING],
        "investment_categories": [InvestmentCategory.HEAT_SOURCE_REPLACEMENT],
    },
    "pruszkow-cieple-mieszkanie": {
        "slug": "pruszkow-cieple-mieszkanie",
        "title": "Ciepłe Mieszkanie — Pruszków",
        "organizer": "Miasto Pruszków",
        "location_slugs": ["pruszkow"],
        "beneficiary_types": [BeneficiaryType.NATURAL_PERSON, BeneficiaryType.OWNER],
        "property_types": [PropertyType.APARTMENT, PropertyType.HOUSING_COMMUNITY],
        "investment_categories": [
            InvestmentCategory.HEAT_SOURCE_REPLACEMENT,
            InvestmentCategory.THERMAL_MODERNIZATION,
        ],
    ...
    "brwinow-wymiana-pieca-2026": {
        ...
        "title": "Gminne dofinansowanie do wymiany pieca w Brwinowie",
        "organizer": "Gmina Brwinów",
        "location_slugs": ["brwinow"],
        "beneficiary_types": [BeneficiaryType.NATURAL_PERSON, BeneficiaryType.OWNER],
        "property_types": [PropertyType.EXISTING_BUILDING],
        "investment_categories": [InvestmentCategory.HEAT_SOURCE_REPLACEMENT],
    },
    "michalowice-lokalny-program-piecowy-2026": {
        ...
        "title": "Lokalny Program Piecowy Gminy Michałowice — 2026",
        "organizer": "Gmina Michałowice",
        "location_slugs": ["michalowice"],
        "beneficiary_types": [BeneficiaryType.NATURAL_PERSON, BeneficiaryType.OWNER],
        "property_types": [PropertyType.EXISTING_BUILDING],
        "investment_categories": [InvestmentCategory.HEAT_SOURCE_REPLACEMENT],
    },
    "raszyn-ograniczanie-niskiej-emisji-2026": {
        ...
        "title": "Program Ograniczania Niskiej Emisji Gminy Raszyn — 2026",
        "organizer": "Gmina Raszyn",
        "location_slugs": ["raszyn"],
        "beneficiary_types": [BeneficiaryType.NATURAL_PERSON, BeneficiaryType.OWNER],
        "property_types": [
