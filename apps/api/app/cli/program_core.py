...
from app.services.program_content import ProgramContentError, update_program_core


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Update reviewed public program core fields")
